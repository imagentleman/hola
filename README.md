# Hola - Nodeknockout 2017

Play and learn how to pronounce the most common words in Spanish!

## URLs
https://stark-hamlet-56388.herokuapp.com/
...
in the `engines` section in your `package.json` so that Heroku will use the same
versions to deploy your application. [Read more in our docs here](https://devcenter.heroku.com/articles/nodejs-support#specifying-a-node-js-version).
...
Now that your application is working locally, you can deploy to Heroku by running:
...
Now you're up and running on Heroku! Time to build!
